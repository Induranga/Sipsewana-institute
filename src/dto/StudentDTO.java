...
public class StudentDTO {
    ...
    public StudentDTO(String id, String nic, String name, String dateOfBirth, String gender, String parentName, String mobile, String address, String ol_result, String al_result, String email, CourseDTO courseDTO) {
        this.setId(id);
        this.setNic(nic);
        this.setName(name);
